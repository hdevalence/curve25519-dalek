          ...
          J::Item: Borrow<EdwardsPoint>,
{
    ...
    #[cfg(all(feature="nightly", all(feature="avx2_backend", target_feature="avx2")))]
    {
        ...
        let Q = multiscalar_mul::<I, _, ExtendedPoint, CachedPoint, ExtendedPoint>(scalars, converted_points);
        EdwardsPoint::from(Q)
    }
    // Otherwise, proceed as normal:
    #[cfg(not(all(feature="nightly", all(feature="avx2_backend", target_feature="avx2"))))]
    {
        multiscalar_mul::<I, J, EdwardsPoint, ProjectiveNielsPoint, CompletedPoint>(scalars, points)
    }
}
